...
extern void Print_Class_Data(Class* C, s32 choice);// print all the class due to id==Random or name==Alphabetical or index==Queue
extern void Print_Class_Score(Class*C, s32 subject);// print all class scores of all subjects
extern void Edit_Class_Score(Class*C, s32 subject);// print all class scores of all subjects
